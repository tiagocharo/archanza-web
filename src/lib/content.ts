export const siteConfig = {
  name: "Archanza",
  tagline: "Arquitetura & Interiores que transformam o seu espaço.",
  email: "contato@archanza.com.br",
  whatsapp: "+55 41 98485-4990",
  instagram: "@archanzahouse",
  address: "Curitiba / PR",
  url: "https://archanza.com.br",
} as const;
...
export const story = {
  ...
  paragraphs: [
    "Somos a Archanza, um escritório de arquitetura apaixonado por transformar ambientes em experiências que conectam pessoas.",
    "Acredito que a arquitetura vai além da estética — ela precisa funcionar, acolher e inspirar quem vive naquele espaço.",
    "Nossa abordagem une escuta ativa, design autoral e atenção obsessiva aos detalhes.",
    "Cada projeto é único porque cada cliente é único.",
    "Do primeiro croqui à entrega final, nosso compromisso é transformar sua visão em realidade — com sensibilidade, técnica e dedicação.",
  ],
} as const;
...
export const differentiators = {
  title: "O que torna nosso trabalho diferente.",
  subtitle:
...
export const partners = {
  ...
  testimonials: [
    {
      quote:
        "A Archanza entendeu exatamente o que queríamos e entregou um projeto que superou todas as expectativas.",
...
export const finalCta = {
  ...
  text: "Cada projeto começa com uma conversa. Conte-nos sobre o seu sonho e juntos vamos criar algo único.",
